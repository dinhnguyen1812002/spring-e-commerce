...
//
//            List<String> sheets = productImportService.getAvailableSheets(file, fileType);
//
...
//            ImportPreviewDTO preview = productImportService.previewImport(file, fileType, sheetName);
//
...
//    public ResponseEntity<?> previewGoogleSheetsImport(@RequestBody Map<String, String> request) {
//        try {
//            String spreadsheetId = request.get("spreadsheetId");
//            String sheetName = request.get("sheetName");
//
//            if (spreadsheetId == null || sheetName == null) {
//                return ResponseEntity.badRequest().body("spreadsheetId and sheetName are required");
//            }
//
//            ImportPreviewDTO preview = productImportService.previewGoogleSheetsImport(spreadsheetId, sheetName);
//
//            return ResponseEntity.ok(preview);
//
//        } catch (Exception e) {
...
//    public ResponseEntity<ColumnMappingDTO> getColumnMappingInfo(@RequestParam List<String> columns) {
//        ColumnMappingDTO mappingInfo = productImportService.getColumnMappingInfo(columns);
//        return ResponseEntity.ok(mappingInfo);
//    }
//
//    @PostMapping("/start")
//    public ResponseEntity<?> startImport(@RequestBody ProductImportRequestDTO request) {
//        try {
//            ProductImportResponseDTO response = productImportService.startImport(request);
...
//        try {
//            ProductImportResponseDTO response = productImportService.getImportStatus(importId);
//            return ResponseEntity.ok(response);
//
...
//        List<ProductImportResponseDTO> imports = productImportService.getAllImports();
...
//                    .header("Content-Disposition", "attachment; filename=import-errors-" + importId + ".xlsx")
//                    .body(report);
//
//        } catch (UnsupportedOperationException e) {
//            return ResponseEntity.notImplemented().body("Error report download not yet implemented");
//        } catch (Exception e) {
//            return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
...
//    public ResponseEntity<?> extractGoogleSheetsId(@RequestBody Map<String, String> request) {
//        try {
