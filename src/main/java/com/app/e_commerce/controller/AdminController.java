...
import com.app.e_commerce.services.impl.DashboardServiceImpl;
...
public class AdminController {
    ...
    public String dashboard(Model model) {
        ...
        BigDecimal lastMonthRevenue = dashboardService.getMonthlyRevenue(lastMonth.getYear(),
        ...
        model.addAttribute("totalRevenue",
                dashboardService.getTotalRevenue() != null ? dashboardService.getTotalRevenue() : BigDecimal.ZERO);
    ...
    // Product product = productService.findById(id); // Sử dụng findById thay vì
    // getProductById
    ...
    public String orderDetail(@PathVariable String orderId, Model model, HttpServletRequest request) {
        ...
        model.addAttribute("pageDescription", "Xem và quản lý chi tiết đơn hàng");
